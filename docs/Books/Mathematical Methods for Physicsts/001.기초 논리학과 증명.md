...
논리적 동치 관계의 연쇄 이용하기, 논리적 동치 관계는 transitivity하다. $p \leftrightarrow q$, $q \leftrightarrow r$로 부터 $p \leftrightarrow r$을 유도해낼 수 있다.

<table>
    <tr>
        <th>
        
        $p \leftrightarrow q$<br> 
        $q \leftrightarrow r$
