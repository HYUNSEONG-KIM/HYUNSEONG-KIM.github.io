...
Thm</th>
<th style="text-align:left;"> 
Properties of Linear transform</th>
<tr style="text-align:center;">
<td colspan="2">
...
구체적으로  $V \approx W$와 그 동형 사상 $T$, 부분 공간 $S_1 , S_2 \subset V$에 대해
 ...
 <center>
 체 $\mathcal{F}$ 위에서 정의된, $\text{dim}(V) = n \in \mathcal{N}$인 벡터 공간 $V$에 대해, 다음이 성립한다.
